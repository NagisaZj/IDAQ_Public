...
from rlkit.torch.sac.sac import CPEARL,FOCALSoftActorCriticModel2
    ...
    if variant['algo_type'] == 'CPEARL':
        ...
        if 1:  # foce random
            ...
            if 'goal_radius' in variant['env_params']:
                algorithm = FOCALSoftActorCriticModel2(
                    env=env,
                    train_tasks=train_tasks,
                    eval_tasks=eval_tasks,
                    nets=[agent, qf1, qf2, vf, c, reward_models, dynamic_models],
                    latent_dim=latent_dim,
